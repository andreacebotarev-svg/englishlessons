...
class ContextGenerator {
  constructor(config = {}) {
    ...
    // Dialogue patterns: [speaker1Context, speaker2Context, correctVerbs]
    this.patterns = [
      {
        template: [
  ...
  generate() {
    ...
    return {
      question: `<div style="margin-bottom: 1rem; font-weight: 600;">Complete the dialogue:</div>${context}`,
      options,
      ...
      metadata: {
        ...
        explanation: `First blank: '${pronoun1}' uses '${verb1}'. Second blank: '${pronoun2}' uses '${verb2}'.`,
