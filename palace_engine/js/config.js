...
const CONFIG = {
    // === CAMERA SETTINGS ===
    camera: {
        speed: 50,              // Скорость движения вперёд/назад (px/tick)
        rotationSpeed: 2,       // 🆕 Скорость поворота (градусы/tick)
        strafeSpeed: 30,        // 🆕 Скорость движения влево/вправо (px/tick)
        smoothing: 0.15,        // 🆕 Коэффициент сглаживания поворота (0-1, чем меньше - плавнее)
        fov: 1000,              // 🆕 Перспектива / Field of View (px)
    ...
    corridor: {
        ...
        roomBox: {
            enabled: true,       // 🟢 Флаг включения режима комнат (включено для room-box)
