...
import { shuffle, generateDistractors, wait, playSuccessAnimation, playErrorAnimation, createElement, announce, sound } from './utils.js';
...
function renderTrainerUI(lesson, state) {
  ...
  const wordDisplay = createElement('div', { className: 'container-sm' }, [
    createElement('div', { className: 'word-display glass' }, [
  ...
  // Check button
  const checkButton = createElement('div', { className: 'container-sm', style: 'text-align: center;' }, [
    createElement('button', {
